...
<p>In views.py you can see the original value of the variable.</p>
...
The filter Tag
The filter tag allows you to run a whole section of code through a filter, and return it according to the
filter keyword(s).
