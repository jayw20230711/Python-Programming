...
xbar	    Optional. The mean of the given data (can also be a second moment around a point that is not the mean).
            If omitted (or set to None), the mean is automatically calculated
...
print('pvariance ', statistics.pvariance([1, 3, 5, 7, 9, 11]))
print('variance ', statistics.variance([1, 3, 5, 7, 9, 11]))
print('pvariance ', statistics.pvariance([2, 2.5, 1.25, 3.1, 1.75, 2.8]))
print('variance ', statistics.variance([2, 2.5, 1.25, 3.1, 1.75, 2.8]))
print('pvariance ', statistics.pvariance([-11, 5.5, -3.4, 7.1]))
print('variance ', statistics.variance([-11, 5.5, -3.4, 7.1]))
print('pvariance ', statistics.pvariance([1, 30, 50, 100]))
