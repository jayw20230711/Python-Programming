...
combine_first()	    Compare two DataFrames, and if the first DataFrame has a NULL value, it will be filled with the
                    respective value from the second DataFrame
...
print(' DataFrame:\n', df)
print('\nFind the absolute value of each value')
print(df.abs())
...
df = pd.DataFrame(data)
print('\nAdd 15 to each value in the Data:', data)
print(df.add(15))
...
newdf2 = df.rename(columns={"age": "p_age"})
print('\n', newdf2)
...
"""
data = [['15-NOV-22', 6, 19, 28, 46, 61, 18, '2X'],
        ['11-NOV-22', 1, 5, 17, 37, 70, 22, '3X'],
        ['08-NOV-22', 5, 13, 29, 38, 59, 23, '4X'],
        ['04-NOV-22', 2, 20, 47, 55, 59, 19, '2X'],
        ['01-NOV-22', 5, 9, 15, 16, 17, 25, '3X']]
...
newdf = df.rename(columns={0: 'DRAW', 1: "B1", 2: "B2", 3: "B3", 4: "B4", 5: "B5", 6: "MGB", 7: "MP"})
# print(newdf)
# print('\n', newdf.iloc[[0, 2], [0, 7]])
# print('\n', newdf.iloc[0:4])
# print('\n length of newdf : ', len(newdf))
