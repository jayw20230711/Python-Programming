...
A large standard deviation indicates that the data is spread out, - a small standard deviation indicates that the
...
xbar	    Optional. The mean of the given data (can also be a second moment around a point that is not the mean). If
            omitted (or set to None), the mean is automatically calculated
