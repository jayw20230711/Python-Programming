"""
Decision Tree
In this chapter we will show you how to make a "Decision Tree". A Decision Tree is a Flow Chart, and can help you
...
Now, based on this data set, Python can create a decision tree that can be used to decide if any new shows are
worth attending to.
...
# print("Read and print the data set: ")
# print(df)
...
# print("Change string values into numerical values: ")
# print(df)

"""
Then we have to separate the feature columns from the target column.

The feature columns are the columns that we try to predict from, and the target column is the column with the 
values we try to predict.
"""
...
# print("X is the feature columns :")
# print(X)
...
Where x is the number of positive answers("GO"), n is the number of samples, and y is the number of negative 
answers ("NO"), which gives us this calculation:
...
Nationality
Nationality <= 0.5 means that the comedians with a nationality value of less than 0.5 will follow the arrow to the 
left (which means everyone from the UK, ), and the rest will follow the arrow to the right.
...
Age
Age <= 35.5 means that comedians at the age of 35.5 or younger will follow the arrow to the left, and the rest will 
...
Experience
Experience <= 9.5 means that comedians with 9.5 years of experience, or less, will follow the arrow to the left, and 
...
Example: Should I go see a show starring a 40 years old American comedian, with 10 years of experience, and a 
comedy ranking of 7?
...
That is because the Decision Tree does not give us a 100% certain answer. It is based on the probability of an 
outcome, and the answer will vary.
