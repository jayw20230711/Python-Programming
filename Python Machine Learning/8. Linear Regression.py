...
show you how to use these methods instead of going through the mathematical formulas.

In the example below, the x-axis represents age, and the y-axis represents speed. We have registered the age and
speed of 13 cars as they were passing a tollbooth. Let us see if the data we collected could be used
...
# The result: 0.013 indicates a very bad relationship, and tells us that this data set is not
